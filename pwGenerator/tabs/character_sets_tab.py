...
class CharacterSetsTab(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.use_lower     = QCheckBox("q,w,e,r..."); self.use_lower.setChecked(True)
        self.use_upper     = QCheckBox("Q,W,E,R..."); self.use_upper.setChecked(True)
        self.use_digits    = QCheckBox("0-9");    self.use_digits.setChecked(True)
        self.use_symbols   = QCheckBox("!@#$..."); self.use_symbols.setToolTip("!@#$%^&*")
        self.use_punct     = QCheckBox(".,;:!?"); self.use_punct.setToolTip(".,;:!?")
        self.use_quotes    = QCheckBox("' \" `"); self.use_quotes.setToolTip("' \" `")
        self.use_dashslash = QCheckBox("- _ / \\"); self.use_dashslash.setToolTip("- _ / \\")
        self.use_math      = QCheckBox("+ = * % < > ^ ~ |"); self.use_math.setToolTip("+=*%<>^~|")
        self.use_braces    = QCheckBox("() [] {}"); self.use_braces.setToolTip("() [] {}")
